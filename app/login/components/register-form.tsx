  ...
  const clearPublicCaches = () => {
    try {
      ...
      const keysToRemove = [
        ...
        'cs_step_keys', 'cs_step6', 'cs_step7_tasks', 'cs_step7_matrix', 'cs_step7_job_state',
      ...
      <div className="bg-white rounded-b-lg p-4 sm:p-6 md:p-8 shadow-lg">
        <div className="mb-8">
          <h2 className="text-2xl font-normal text-gray-800">
            Welcome To <span className="text-blue-600 font-semibold">Mindsurf</span>
          </h2>
        </div>
        ...
        >
          ...
          <div className="flex flex-col justify-center gap-3">
            <button
              ...
              className="w-full bg-white border border-gray-200 rounded-full flex items-center justify-center hover:bg-gray-50 shadow-sm transition-colors py-3 px-4 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isGoogleLoading ? (
